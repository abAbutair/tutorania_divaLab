...
(function($) {
    ...
    $.datePicker = {
        default: {
            prev: '<i class="fa fa-chevron-circle-left"></i>',                          // change prev button. html is allowed.
            next: '<i class="fa fa-chevron-circle-right"></i>',                          // change next button. html is allowed.
...
//                var momentForPrint = moment(display).add(-Math.floor((newOption.monthCount - 1) / 2), 'M');
            ...
            function drawMonth($input, newOption, selected, display) {
                ...
                if(newOption.monthCount == 1 && newOption.changeMonthYear){
                    ...
                    for(var i = newOption.startYear; i <= newOption.endYear; i++) {
